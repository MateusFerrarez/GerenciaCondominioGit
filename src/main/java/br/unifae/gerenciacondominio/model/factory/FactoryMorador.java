...
import br.unifae.gerenciacondominio.model.Morador;
 ...
 * @author mateu
 */
public class FactoryMorador implements Factory {

    private Connection dbConnection;

    public FactoryMorador(Connection dbConnection) {
    ...
    public void insertPessoa(String nome, String cpf, String rg, LocalDate dtNascimento) throws SQLException {
        ...
        var stament = SqlInsertSchemas.queryInsertMorador(dbConnection);
    ...
    public List<Pessoa> getPessoas() throws SQLException {
        ...
        var result = SqlSelectSchemas.queryGetMoradores(dbConnection);
    ...
    public void updatePessoa(Long idPessoa, String nome, String cpf, String rg, LocalDate dtNascimento) throws SQLException {
        ...
        var stament = SqlUpdateSchemas.queryUpdateMorador(dbConnection);
        stament.setString(1, proprietario.getNome());
        stament.setString(2, proprietario.getRg());
        stament.setString(3, proprietario.getCpf());
        stament.setString(4, proprietario.getDtNascimento().toString());
    ...
    public Pessoa getPessoaById(Long idPessoa) throws SQLException {
        var result = SqlSelectSchemas.queryGetMoradorById(dbConnection, idPessoa);
        Morador proprietario = null;
        ...
        while (result.next()) {
            ...
            final String rua = result.getString(5);
            final String cep = result.getString(6);
            final String numero = result.getString(7);
            final Long idResidencia = result.getLong(8);

            final Residencia tempResidencia = new Residencia(idResidencia, rua, numero, cep);

            proprietario = new Morador(idPessoa, nome, rg, cpf, data, tempResidencia);
        }
    ...
    public void deletePessoaById(Long idPessoa) throws SQLException {
        var result = SqlDeleteSchemas.queryDeleteMorador(dbConnection);

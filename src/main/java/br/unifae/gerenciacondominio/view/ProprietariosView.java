...
public class ProprietariosView extends javax.swing.JFrame {
    ...
    private ProprietariosController controller;
    ...
    public ProprietariosView() {
        ...
        try {
            ...
            controller = new ProprietariosController(connection);
            controller.fillTable(jTable1);
            factory = new FactoryProprietario(connection);
    ...
    private void initComponents() {
        ...
        setTitle("Tela de proprietarios");
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        try {
            JDialog modalDialog = new ManipulaPessoa((Frame) getParent(), "Cadastrar proprietario", true, connection, factory);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linhaSelecionada == -1) {
            JOptionPane.showMessageDialog(rootPane, "Selecione um proprietario antes!", "Aviso!", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            JDialog modalDialog = new ManipulaPessoa((Frame) getParent(), "Editar proprietario", true, connection, true, idSelecionado, factory);
            modalDialog.addWindowListener(new WindowAdapter() {
                @Override
                public void windowClosed(WindowEvent e) {
                    try {
    ...
    private void btnApagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApagarActionPerformed
        ...
        try {
            ...
            controller.deletarProprietario(idLong);
            controller.fillTable(jTable1);
            JOptionPane.showMessageDialog(rootPane, "Proprietario deletado com sucesso!", "Sucesso!", JOptionPane.PLAIN_MESSAGE);
        } catch (SQLException sqle) {
            JOptionPane.showMessageDialog(rootPane, "Erro ao deletar Proprietario!", "Erro!", JOptionPane.ERROR_MESSAGE);
            System.out.println(sqle);
        } catch (Exception exception) {
            JOptionPane.showMessageDialog(rootPane, "Erro desconhecido ao deletar Proprietario!", "Erro!", JOptionPane.ERROR_MESSAGE);
